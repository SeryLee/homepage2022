		...
		<c:choose>
			...
			<c:when test="${step eq '1'}">
				<li>
					...
					<%--순수 JSP 문법 / java의 string에 저장하여 출력--%>
			...
			<c:when test="${step eq '3'}">
				<li>
					...
					<h4>기본 문법 : &#60;c:set var="변수명" value="값"/&#62;</h4>
			...
			<c:when test="${step eq '4'}">
				<li>
					...
					<h4>기본 문법 : &#60;c:if test="조건문"&#62; &#60;/c:if&#62;"</h4>
			...
			<c:when test="${step eq '6'}">
				<li>
					<h3>c:forEach Tag : 기본 반복 태그, 고정 된 횟수 또는 초과 수집 동안 중첩된 본문 내용을 반복</h3>
					<h4>기본 문법 : <br>
			...
			<c:when test="${step eq '7'}">
				<li>
					...
					<h4>기본 문법: &#60;c:param name="변수명" value="값"/&#62;</h4>
			...
			<c:when test="${step eq '8'}">
				<li>
					...
					<h4>기본 문법: &#60;c:url var="변수명" value="값"/&#62;</h4>
					...
					<a href="${link2}" target="_blank" title="새창열기">링크 2번</a>
				</li>
			</c:when>
			...
			<c:when test="${step eq '10'}">
				<li>
					<h3>fn:indexOf() : 주어진 문자열이 특정 문자열로 끝나는지 확인하는데 사용</h3>
