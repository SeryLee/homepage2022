...
<body>
	<div id="all">
		<header id="header">
			...
			<nav class="gnb">
				<ul>
					<li><a href="/board/selectList.do">게시판으로 궈궈</a></li>
		...
		<footer class="footer">
			<p class="ff">
				nana companyp<br>happy house 104-902 Bukgu Busan Korea.
			</p>
		</footer>
		...
		<div class="layer-popup layer-login" style="display: none;">
			<header class="layer-header">
				<span class="logo"> <span class="img-logo">나나상담소</span>
				</span>
